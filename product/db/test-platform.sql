...
--
-- RUN:
--   node product/db/test.mjs platform
--
-- That builds pd_t_platform from product/db/migrations/ via the migration runner and
...
--   psql -h /tmp -p 5433 -U app -d pd_t_platform -f product/db/test-platform.sql
--
